...
const Stories: NextPage = () => {
  ...
  const allStories = [
    <div key="1" className={styles.storyCard}>
      ...
      Двоє дітей, чоловік на фронті. Я трималась як могла, але ввечері зривалась на дітей через будь-яку дрібницю. А потім лежала і плакала від сорому. Щовечора одне й те саме. <br /><br />Побачила рекламу, пройшла тест. Думала — ну 189 грн, що я втрачу? Гірше вже не буде. <br /><br />На 2-й день зробила вечірню практику перед тим, як забирати дітей з садочка. Вперше за місяці не підвищила голос увесь вечір. <br /><br />На 3-й день донька сказала: «Мамо, ти стала добріша». <br /><br />Це було найкраще, що я чула за рік.
      </p>
    </div>,
    ...
    <div key="4" className={styles.storyCard}>
      ...
      <p className={styles.storyText}>
      Снодійні, мелатонін, вино перед сном. Пробувала медитації — не можу зосередитись. Психолога — дорого і не завжди є час. Нічого не давало нормального сну. <br /><br />Пройшла тест із думкою «ну подивлюсь, що запропонують». 189 грн — менше, ніж пачка мелатоніну. Вирішила спробувати. <br /><br /> На 3-й день вперше прокинулась і зрозуміла — я виспалась. Не пам'ятала, коли таке було востаннє. <br /><br />Тут інакше. Через тіло, не через голову. Шкода, що не знайшла раніше.
      </p>
    </div>,
